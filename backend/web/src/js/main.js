...
(() => {
    ...
    * */
    ...
    /*services*/
    const servicesArr = document.querySelectorAll('.servicesElem .controlServicesBtn');
    /*text editor*/
    ...
    /*cropper get*/
    const cropperWrapGet = document.querySelectorAll('.cropper_change');
    /*slider*/
    const slider = document.querySelector('.slider_edit');
    /*control table*/
    const tableArr = document.querySelectorAll('.tableWrap');
    ...
    * */
    ...
    //     (require('./modules/controlTable'))(tableArr);
    // }
